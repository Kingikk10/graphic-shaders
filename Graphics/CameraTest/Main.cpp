...
void main()
{
	...
	Shader pfrag = loadShader("../res/shaders/postVert.glsl", "../res/shaders/postFrag.glsl");

	Framebuffer screen = { 0, 1280, 720 };

	// colors don't need floats, but position/normals opehould use it.
	...
	// Temporary shadow framebuffer. Will be cleared and reused by each liaaght!
	...
	while (context.step())
	{
		...
		tdraw(pfrag, spear, gframe, spearModel, camView, camProj, white, spear_normal, white);
		///////////////////
		// FOR ARTHUR!!!!!!
